...
\begin{enumerate}
    ...
    \item \hl{Đường màu cam (Thuật toán Sắp xếp). Ta cũng có thể xem là Thuật toán Fast-Sampling, vì chỉ khác ở tử số $\alpha \epsilon$ rất nhỏ}
    \item \hl{Đường màu xanh dương (Thuật toán Fast-Estimation)}
    \item \hl{Đường màu xám (Thuật toán Fast-Filtering)}
\end{enumerate}

\hl{
Tỷ lệ xấp xỉ càng ít là càng tốt.    
}
