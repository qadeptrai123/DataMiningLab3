...
\begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption{\hl{Bổ đề 6: Khoảng cách giữa trọng tâm mẫu $I_{ij}$ và trọng tâm thực $Q_{ij}$. $\alpha = 30\%$. Với điều kiện bài toán $\alpha < 1/2$ số điểm trong tập giao lớn dẫn đến chặn trên khoảng cách giữa hai trọng tâm.}}
\end{figure}
