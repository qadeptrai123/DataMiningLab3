...
% BEGIN PB
\hl{Nếu $P$ là 1 điểm (thay vì 1 tập hợp) thì công thức trên được dùng. Lưu ý ta quan tâm thứ tự trong toán tử $\delta^2$, viết cụm trước và tâm sau.}
% END PB
...
% BEGIN PB
\hl{Bổ đề \ref{lemma:2} cũng đúng với $J \subset \mathbb{R}^d$, mặc dù tác giả chỉ ghi trên $\mathbb{R}$, xem chứng minh trong bài báo của Nguyen và tác giả cộng sự} (\cite{Nguyen2022}, \hl{phần chứng minh Bổ đề 3 trong mục Appendix 5.1).}
