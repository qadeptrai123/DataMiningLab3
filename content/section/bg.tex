...
% BEGIN PB
Bổ đề trên cũng đúng với $J \subset \mathbb{R}^d$, mặc dù tác giả chỉ ghi trên $\mathbb{R}$, xem chứng minh ở \ref{sec:proofs}.
 % TODO \ref
...
\begin{tikzpicture}[line cap=round, line join=round, >=triangle 45, x=1cm, y=1cm]
    ...
    \end{scriptsize}
\end{tikzpicture}
\caption{Minh họa Bổ đề 2 trong không gian $\mathbb{R}^d$: Khoảng cách giữa tâm tập tổng thể $\overline{J}$ và tâm tập con $\overline{J_1}$ được chặn bởi hàm chi phí của $J$.}
\end{figure}
